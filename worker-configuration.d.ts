/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 62aaa4aa6b8b65e4f95b0b473d1a4881)
// Runtime types generated with workerd@1.20260828.1 2026-08-25 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	APP_ENVIRONMENT: "production";
	TURNSTILE_SITE_KEY: "0x4AAAAAAEiVBZSmlCJT9AMI";
	DOCUMENT_ROOM: DurableObjectNamespace<import("./src/index").DocumentRoom>;
	CANVAS_ROOM: DurableObjectNamespace<import("./src/index").CanvasRoom>;
	TURNSTILE_VERIFY: Fetcher /* turnstile-siteverify-webmcp-game */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DocumentRoom" | "CanvasRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENVIRONMENT" | "TURNSTILE_SITE_KEY">> {}
}
